...
const slideMetadataConfig = {
  'front-1': {
    ...
    description: 'Providing premier CBSE curriculum with smart classrooms, science laboratories, sports, and holistic character development under Principal Manish Singh.',
